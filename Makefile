...
OTA ?= espboot
OTA_APP_ADDR = 0x2000
OTA_BOOTLOADER_PATH = C:/Espressif/esp-bootloader/firmware/espboot.bin
...
USER_MODULES		=  shared user driver mqtt modules http upgrade websrv persistence sensor lcd weather
USER_INC				= include
USER_LIB				=
